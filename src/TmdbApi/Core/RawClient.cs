...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<TmdbApi.Core.ApiResponse> MakeRequestAsync(
        TmdbApi.Core.BaseRequest request,
    ...
    internal async Task<TmdbApi.Core.ApiResponse> SendRequestAsync(
        TmdbApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<TmdbApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new TmdbApi.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(TmdbApi.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(TmdbApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use TmdbApi.Core.ApiResponse instead.")]
    internal record ApiResponse : TmdbApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use TmdbApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : TmdbApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use TmdbApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : TmdbApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use TmdbApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : TmdbApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use TmdbApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : TmdbApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use TmdbApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : TmdbApi.Core.StreamRequest;
}
